...
function Hero() {
  return (
    <div className="relative min-h-screen flex items-center" id="home">
      <div
        aria-hidden="true"
        className="absolute inset-0 grid grid-cols-2 -space-x-52 opacity-40 transition-opacity duration-1000"
      >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-2">
        <div className="relative pt-20 pb-20 px-4 sm:px-6 lg:px-8 transition-all duration-1000 ease-in-out opacity-100 translate-y-0">
          <div className="lg:w-2/3 text-center mx-auto">
            <div className="bg-indigo-800 rounded-2xl p-4 inline-block mx-auto mb-8 transform transition-transform duration-500 hover:scale-110">
              ...
              >
                ...
                <path
                  d="M7 7h10v2H7V7zM7 11h10v2H7v-2zM7 15h10v2H7v-2z"
                  fill="white"
                />
              </svg>
            </div>
            <h1 className="text-gray-100 font-normal text-4xl sm:text-5xl md:text-6xl xl:text-8xl mb-8 transition-all duration-500 font-sans">
              Elevate Your Insights with{" "}
              <span className="text-primary">AI-Driven Summaries</span>
            </h1>
            <p className="text-gray-500 font-thin text-lg sm:text-xl mb-12 transition-all duration-500">
              Enhance your content consumption. Leverage our AI summarization
              tool for concise, accurate, and insightful summaries.
            </p>
