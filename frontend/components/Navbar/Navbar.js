      ...
      <nav className="bg-gray-500 bg-opacity-20 backdrop-blur-2xl fixed z-20 w-3/4 top-4 py-5  lg:rounded-full rounded-2xl mx-auto lg:mx-72">
        <div className="container mx-auto flex flex-wrap items-center justify-between px-6">
          <Link href="/" className="flex items-center">
            <span className="ml-2 text-2xl font-thin text-white">
              QuickSumm{" "}
              <span className="text-blue-600 rounded-md -ml-1">.AI</span>
            </span>
          </Link>
          <button
          ...
          >
            <div className="lg:flex lg:items-center lg:justify-between lg:space-x-8 lg:w-full text-white font-thin transition duration-150 ease-in-out">
              <div className="lg:ml-32 lg:flex lg:justify-evenly lg:gap-x-8 lg:w-full ">
                <a
                  href="#"
                  className="block lg:inline-block mt-4 lg:mt-0 text-lg relative group"
                >
              ...
              {user ? (
                <div className="flex flex-col lg:flex-row lg:space-x-3 mt-4 lg:mt-0">
                  <Link
                    ...
                    className="text-lg text-white bg-blue-800 px-4 py-2 rounded-full mb-2 lg:mb-0 hover:bg-blue-700 transition-colors duration-300 text-center"
                  >
                    Dashboard
                  </Link>
                  <button
                    onClick={logout}
                    className="text-lg text-white px-4 py-2 border r-blue-800 rounded-full mb-2 lg:mb-0 hover:bg-red-600 hover:text-white transition-colors duration-300"
                  >
                    Logout
                  </button>
                </div>
                ...
                <div className="flex flex-col lg:flex-row lg:space-x-3 mt-4 lg:mt-0">
                  ...
                  <Link
                    href="/register"
                    className="text-lg text-white border px-4 py-2 rounded-full mb-2 lg:mb-0 hover:bg-blue-800 hover:text-white hover:border-none transition-colors duration-300 text-center"
                  >
                    Register
                  </Link>
                </div>
